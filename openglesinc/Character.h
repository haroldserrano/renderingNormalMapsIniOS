...
//count of vertices
#define VERTEXCOUNT 3942
#define TRIANGLECOUNT 1314
#define UVCOUNT 2628
...
private:
    ...
    GLint NormalMapUniformLocation; //OpenGL location for the Normal Texture Map
    ...
    GLuint tangentLocation; //attribute "tangent" location
    
    vector<unsigned char> image;
    unsigned int imageWidth, imageHeight;
    
    //The size of the tangent array is calculated by adding the number of vertices + (number of vertices)/3. Recall that the tangent array hold 4 elements per vertex instead of 3.
    float smallHouse_tangent[VERTEXCOUNT+(VERTEXCOUNT/3)];
