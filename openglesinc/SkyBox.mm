...
void SkyBox::setupOpenGL(){
    ...
    http://www.cgdemy.com/blog/loading-vertex-normal-and-uv-data-onto-opengl-buffers
    */
    ...
    /*Since we are going to start the rendering process by using glDrawElements
     ...
     if not familiar. http://www.cgdemy.com/blog/starting-the-primitive-rendering-process-in-opengl */
...
void SkyBox::update(float dt){
    ...
    modelSpace=GLKMatrix4Rotate(modelSpace, dt, 0.0f, 1.0f, 0.0f);
...
void SkyBox::setTransformation(){
    ...
    cameraViewSpace =GLKMatrix4MakeTranslation(0.0f, 0.0f, -0.9f);
