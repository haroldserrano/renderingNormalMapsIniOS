...
- (void)viewDidLoad
{
    ...
    //7. Calculate the tangent vectors of the character
    character->calculateTangentVectors();
    
    //8. Begin the OpenGL setup for the character
...
- (void)update
{
    character->update(currentTouchPoint);
